...
describe('Tools list', () => {
    ...
    it('should render list of tools', async () => {
        ...
        expect(within(card1).getByText(/ia/))
        expect(within(card1).getByText(/chat/))
        ...
        expect(within(card2).getByText(/help/))
        expect(within(card2).getByText(/ctrlC/))
        expect(within(card2).getByText(/ctrlV/))
        expect(within(card2).getByText(/ia/))
    })
